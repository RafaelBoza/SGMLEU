...
def mujeres_no_ubicadas_por_fuentes_cierre_mes(request):
    ...
    response[
        'Content-Disposition'] = "attachment; filename=Mujeres_no_ubicadas_por_fuentes.(Cierre del mes anterior)_(%s).xlsx" % (
        nombre_anno)
    ...
    # licenciados_sma = LicenciadosSMA.objects.filter(sexo='F', activo=True).exclude(acepto_oferta='S')
    ...
    egresados_ep = EgresadosEstablecimientosPenitenciarios.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=2,
                                                                           activo=True)
    ...
    sancionados = EgresadosEstablecimientosPenitenciarios.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=3,
                                                                         activo=True)
    ...
    desvinculados = Desvinculado.objects.filter(sexo='F', ubicado=False, activo=True)
    ...
    tecnicos_medio = TMedioOCalificadoEOficio.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=6,
                                                                activo=True)
    ...
    obreros_calificados = TMedioOCalificadoEOficio.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=7,
                                                                    activo=True)
    ...
    escuelas_oficio = TMedioOCalificadoEOficio.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=8,
                                                                activo=True)
    ...
    egresados_escuelas_especiales = EgresadosEscuelasEspeciales.objects.filter(sexo='F', ubicado=False, activo=True)
    ...
    egresados_escuelas_conducta = EgresadosEscuelasConducta.objects.filter(sexo='F', ubicado=False, activo=True)
    ...
    egresados_efi = EgresadosEFI.objects.filter(sexo='F', ubicado=False, activo=True)
    ...
    menores_incapacitados = Menores.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=12, activo=True)
    ...
    menores_desvinculados = Menores.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=13, activo=True)
    ...
    menores_dictamen = Menores.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=14, activo=True)
    ...
    discapacitados = Discapacitados.objects.filter(sexo='F', ubicado=False, activo=True)
    ...
    mujeres_riesgo_pnr = PersonasRiesgo.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=17, activo=True)
    ...
    hombres_riesgo_pnr = PersonasRiesgo.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=18, activo=True)
    ...
    proxenetas = PersonasRiesgo.objects.filter(sexo='F', ubicado=False, fuente_procedencia_id=19, activo=True)
    ...
    for provincia in provincias:
        # NO UBICADOS: Licenciados del SMA
        total_licenciados_sma_provincias.append(0)
