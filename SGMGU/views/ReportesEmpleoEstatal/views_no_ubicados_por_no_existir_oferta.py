...
def no_ubicados_por_no_existir_oferta(request):
    ...
    egresados_escuelas_especiales = EgresadosEscuelasEspeciales.objects.filter( causa_no_ubicado_id=1, activo=True)
