...
from SGMGU.views.utiles import permission_required, obtener_mes


@login_required()
@permission_required(['administrador', 'dpt_ee', 'dmt'])
def total_personas_no_ubicadas_provincias_y_municipios(request):
    ...
    if categoria_usuario == 'dpt_ee':
        response['Content-Disposition'] = "attachment; filename=Total_de_personas_ubicadas_por_provincia_y_municipios._(%s).xlsx" % (anno)

    elif categoria_usuario == 'dmt':
        response['Content-Disposition'] = "attachment; filename=Total_de_personas_ubicadas._(%s).xlsx" % (anno)

    else:
        response['Content-Disposition'] = "attachment; filename=Total_de_personas_ubicadas_por_provincias_y_municipios._(%s).xlsx" % (anno)
    ...
    total_no_ubicados = 0
    total_mujeres_no_ubicadas = 0
    total_jovenes_no_ubicados = 0
    ...
    if categoria_usuario == 'administrador' or categoria_usuario == 'dpt_ee':
        ...
        for provincia in provincias:
            ...
            no_ubicados_provincia = egresados_ep.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False).count() + \
                                 ...
                                 hombres_riesgo_pnr.filter(municipio_solicita_empleo__provincia=provincia,
                                                           ubicado=False).count() + \
                                 proxenetas.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False).count()

            total_no_ubicados += no_ubicados_provincia
            worksheet_data.write(INDICE, 4, no_ubicados_provincia, formato)

            mujeres_no_ubicadas_provincia = egresados_ep.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                                             sexo='F').count() + \
                                         sancionados.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                                            sexo='F').count() + \
                                         desvinculados.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                                              sexo='F').count() + \
                                         tecnicos_medio.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                                               sexo='F').count() + \
                                         obreros_calificados.filter(municipio_solicita_empleo__provincia=provincia,
                                         ...
                                         escuelas_oficio.filter(municipio_solicita_empleo__provincia=provincia,
                                                                ubicado=False, sexo='F').count() + \
                                         egresados_escuelas_especiales.filter(
                                             municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                             sexo='F').count() + \
                                         egresados_escuelas_conducta.filter(municipio_solicita_empleo__provincia=provincia,
                                                                            ubicado=False, sexo='F').count() + \
                                         egresados_efi.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                                              sexo='F').count() + \
                                         menores_incapacitados.filter(municipio_solicita_empleo__provincia=provincia,
                                                                      ubicado=False, sexo='F').count() + \
                                         menores_desvinculados.filter(municipio_solicita_empleo__provincia=provincia,
                                         ...
                                         menores_dictamen.filter(municipio_solicita_empleo__provincia=provincia,
                                                                 ubicado=False, sexo='F').count() + \
                                         discapacitados.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                                               sexo='F').count() + \
                                         mujeres_riesgo_pnr.filter(municipio_solicita_empleo__provincia=provincia,
                                                                   ubicado=False, sexo='F').count() + \
                                         hombres_riesgo_pnr.filter(municipio_solicita_empleo__provincia=provincia,
                                                                   ubicado=False, sexo='F').count() + \
                                         proxenetas.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                                           sexo='F').count()

            total_mujeres_no_ubicadas += mujeres_no_ubicadas_provincia
            worksheet_data.write(INDICE, 5, total_mujeres_no_ubicadas, formato)

            jovenes_no_ubicados_provincia = egresados_ep.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                                             edad__in=edades_jovenes).count() + \
                                         sancionados.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                                            edad__in=edades_jovenes).count() + \
                                         desvinculados.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                         ...
                                         tecnicos_medio.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False,
                                                               edad__in=edades_jovenes).count() + \
                                         obreros_calificados.filter(municipio_solicita_empleo__provincia=provincia,
                                                                    ubicado=False, edad__in=edades_jovenes).count() + \
                                         escuelas_oficio.filter(municipio_solicita_empleo__provincia=provincia,
                                                                ubicado=False, edad__in=edades_jovenes).count() + \
                                         egresados_escuelas_especiales.filter(
                                             municipio_solicita_empleo__provincia=provincia, ubicado=False,
            ...
            total_jovenes_no_ubicados += jovenes_no_ubicados_provincia
            worksheet_data.write(INDICE, 6, total_jovenes_no_ubicados, formato)

            egresados_ep_provincia = egresados_ep.filter(municipio_solicita_empleo__provincia=provincia,
                                                         ubicado=False).count()
            sancionados_provincia = sancionados.filter(municipio_solicita_empleo__provincia=provincia, ubicado=False).count()
            ...
            worksheet_data.write(INDICE, 7, 0, formato)
            ...
            for municipio in MUNICIPIOS_X:
                ...
                no_ubicados_provincia = egresados_ep.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     sancionados.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     desvinculados.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     tecnicos_medio.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     obreros_calificados.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     escuelas_oficio.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     egresados_escuelas_especiales.filter(municipio_solicita_empleo=municipio,
                                                                          ubicado=False).count() + \
                                     egresados_escuelas_conducta.filter(municipio_solicita_empleo=municipio,
                                                                        ubicado=False).count() + \
                                     egresados_efi.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     menores_incapacitados.filter(municipio_solicita_empleo=municipio,
                                                                  ubicado=False).count() + \
                                     menores_desvinculados.filter(municipio_solicita_empleo=municipio,
                                                                  ubicado=False).count() + \
                                     menores_dictamen.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     discapacitados.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     mujeres_riesgo_pnr.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     hombres_riesgo_pnr.filter(municipio_solicita_empleo=municipio, ubicado=False).count() + \
                                     proxenetas.filter(municipio_solicita_empleo=municipio, ubicado=False).count()

                worksheet_data.write(INDICE, 4, no_ubicados_provincia, formato2)

                mujeres_no_ubicadas_provincia = egresados_ep.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                 sexo='F').count() + \
                                             sancionados.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                sexo='F').count() + \
                                             desvinculados.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                  sexo='F').count() + \
                                             tecnicos_medio.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                   sexo='F').count() + \
                                             obreros_calificados.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                        sexo='F').count() + \
                                             escuelas_oficio.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                    sexo='F').count() + \
                                             egresados_escuelas_especiales.filter(municipio_solicita_empleo=municipio,
                                                                                  ubicado=False, sexo='F').count() + \
                                             egresados_escuelas_conducta.filter(municipio_solicita_empleo=municipio,
                                                                                ubicado=False, sexo='F').count() + \
                                             egresados_efi.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                  sexo='F').count() + \
                                             menores_incapacitados.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                          sexo='F').count() + \
                                             menores_desvinculados.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                          sexo='F').count() + \
                                             menores_dictamen.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                     sexo='F').count() + \
                                             discapacitados.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                   sexo='F').count() + \
                                             mujeres_riesgo_pnr.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                       sexo='F').count() + \
                                             hombres_riesgo_pnr.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                       sexo='F').count() + \
                                             proxenetas.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                               sexo='F').count()

                worksheet_data.write(INDICE, 5, mujeres_no_ubicadas_provincia, formato2)

                jovenes_no_ubicados_provincia = egresados_ep.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                 edad__in=edades_jovenes).count() + \
                                             sancionados.filter(municipio_solicita_empleo=municipio, ubicado=False,
                                                                edad__in=edades_jovenes).count() + \
                                             desvinculados.filter(municipio_solicita_empleo=municipio, ubicado=False,
                ...
                worksheet_data.write(INDICE, 6, jovenes_no_ubicados_provincia, formato2)

                worksheet_data.write(INDICE, 7, 0, formato2)
                worksheet_data.write(INDICE, 8,
                                     egresados_ep.filter(municipio_solicita_empleo=municipio, ubicado=False).count(),
                                     formato2)
                ...
                worksheet_data.write(INDICE, 23,
                                     proxenetas.filter(municipio_solicita_empleo=municipio, ubicado=False).count(), formato2)
        ...
        if categoria_usuario == 'administrador':
            ...
            worksheet_data.write(INDICE, 4, total_no_ubicados, formato)
            worksheet_data.write(INDICE, 5, total_mujeres_no_ubicadas, formato)
            worksheet_data.write(INDICE, 6, total_jovenes_no_ubicados, formato)
            worksheet_data.write(INDICE, 7, 0, formato)
