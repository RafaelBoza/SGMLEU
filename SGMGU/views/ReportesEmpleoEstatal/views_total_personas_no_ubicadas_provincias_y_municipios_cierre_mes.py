...
def total_personas_no_ubicadas_provincias_y_municipios_cierre_mes(request):
    ...
    if categoria_usuario == 'dpt_ee':
        response['Content-Disposition'] = "attachment; filename=Total_de_personas_no_ubicadas_por_provincia_y_municipios_(Cierre_del_mes_anterior)._(%s).xlsx" % (nombre_anno)

    elif categoria_usuario == 'dmt':
        response['Content-Disposition'] = "attachment; filename=Total_de_personas_no_ubicadas_(Cierre_del_mes_anterior)._(%s).xlsx" % (nombre_anno)

    else:
        response['Content-Disposition'] = "attachment; filename=Total_de_personas_no_ubicadas_por_provincias_y_municipios_(Cierre_del_mes_anterior)._(%s).xlsx" % (nombre_anno)
    ...
    if categoria_usuario == 'administrador' or categoria_usuario == 'dpt_ee':
        ...
        for provincia in provincias:
            ...
            no_ubicados_provincia = egresados_ep.filter(municipio_solicita_empleo__provincia=provincia,
                                                        ubicado=False).count() + \
                                    sancionados.filter(municipio_solicita_empleo__provincia=provincia,
                                                       ubicado=False).count() + \
                                    desvinculados.filter(municipio_solicita_empleo__provincia=provincia,
            ...
            mujeres_no_ubicadas_provincia = egresados_ep.filter(municipio_solicita_empleo__provincia=provincia,
                                                                ubicado=False,
                                                                sexo='F').count() + \
                                            sancionados.filter(municipio_solicita_empleo__provincia=provincia,
                                                               ubicado=False,
            ...
            jovenes_no_ubicados_provincia = egresados_ep.filter(municipio_solicita_empleo__provincia=provincia,
                                                                ubicado=False,
                                                                edad__in=edades_jovenes).count() + \
                                            sancionados.filter(municipio_solicita_empleo__provincia=provincia,
                                                               ubicado=False,
            ...
            egresados_ep_provincia = egresados_ep.filter(municipio_solicita_empleo__provincia=provincia,
                                                         ubicado=False).count()
            sancionados_provincia = sancionados.filter(municipio_solicita_empleo__provincia=provincia,
                                                       ubicado=False).count()
