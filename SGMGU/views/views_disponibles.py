...
def m_disponibles(request,errors=None):
    disponibles=DisponibilidadGraduados.objects.filter(fecha_registro__year=datetime.datetime.today().year)
...
@login_required
@permission_required(['administrador','especialista','mes', 'dpts'])
