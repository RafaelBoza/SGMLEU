...
def exportar_expediente(request,id_expediente,):
    ...
    PAGE_WIDTH = A4[0]
    PAGE_HEIGHT = A4[1]
    mes=get_nombre_mes(int(datetime.date.today().month))
    ...
    fecha="La Habana, %s de %s de %s"%(datetime.date.today().day,mes,datetime.date.today().year)
    ...
    try:
        ...
        if sexo_funcionario== "M":
            ...
            p.drawString(60,555,"Estimada compañera:")
